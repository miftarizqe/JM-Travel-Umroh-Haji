...
const MAKS = 10 * 1024 * 1024; // 10MB — samain sama endpoint admin lain

// POST /api/admin/upload-foto-profil  (multipart: file, user_id)
// Versi ADMIN dari /api/upload-foto (self-service, selalu ke akun yang
// lagi login). Buat nge-backfill foto profil akun lama yang belum pernah
// unggah — dipakai bareng cetak ID card.
