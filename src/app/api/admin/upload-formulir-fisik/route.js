...
// POST /api/admin/upload-formulir-fisik  (multipart: file, user_id)
// Unggah scan/foto Formulir Pendaftaran perwakilan yang sudah
// ditandatangani fisik — dokumen BEDA dari SPKA-Ins (lihat
// upload-dokumen-pks-fisik), jadi kolom & folder sendiri.
export async function POST(request) {
  ...
  try {
    ...
    return Response.json({ message: 'Formulir berhasil diunggah!', path: publicPath });
  } catch (error) {
    console.error('Upload formulir fisik gagal:', error);
